...
public class ChatBotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        client = new OkHttpClient.Builder().connectTimeout(30, TimeUnit.SECONDS)   // thời gian chờ kết nối
    ...
    private void getAIReply(String userInput) {
        try {
            ...
            Request request = new Request.Builder().url(ENDPOINT).addHeader("Authorization", "Bearer " + API_KEY).addHeader("Content-Type", "application/json").post(body).build();
