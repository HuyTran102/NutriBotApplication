...
public class RecommendMenuNum4Activity extends AppCompatActivity {
    private final FirebaseFirestore firebaseFirestore = FirebaseFirestore.getInstance();
    private TextView gaoNep, thitBaChi, trungCut, lapXuong, suaDauNanh, nho, gaoTe1, caHo, chaCom, cuaDong, rauDay, dauAn1, chuoi, gaoTe2, thitBo, nam, rauMuong, dauAn2, man, tongSang, tongTrua, tongToi;
    private String name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RecommendMenuNum4Activity.this, RecommendMenuActivity.class);
