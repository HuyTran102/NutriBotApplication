...
public class RecommendMenuNum5 extends AppCompatActivity {
    private FirebaseFirestore firebaseFirestore = FirebaseFirestore.getInstance();
    private TextView banhMi, pate, trung, rauSong, suaChua, cam, gaoTe1, ga
            , thitBaChi, biXanh, rauThom, dauAn1, duaLe, gaoTe2, chaThit, dauPhu, biDo, dauAn2, duDu
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RecommendMenuNum5.this, RecommendMenu.class);
