...
public class RecommendMenuNum2Activity extends AppCompatActivity {
    private final FirebaseFirestore firebaseFirestore = FirebaseFirestore.getInstance();
    private TextView bun, thitBo1, chanGio, rauSong, suaChua, dauTay, gaoTe1, thitGa, muc, khoaiTim, suon, dauAn1, duaHau, gaoTe2, caHoi, thitBo2, rauMongToi, dauAn2, mitThai, tongSang, tongTrua, tongToi;
    private String name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RecommendMenuNum2Activity.this, RecommendMenuActivity.class);
