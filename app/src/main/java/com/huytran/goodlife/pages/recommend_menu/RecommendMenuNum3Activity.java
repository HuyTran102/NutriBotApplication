...
public class RecommendMenuNum3Activity extends AppCompatActivity {
    private final FirebaseFirestore firebaseFirestore = FirebaseFirestore.getInstance();
    private TextView mien, gioSong, cuaBien, rauSong, caramen, le, gaoTe1, cotLet, ghe, trung, bongCaiXanh, dauAn1, mangCau, gaoTe2, caLoc, thitNac, bapCai, dauAn2, duDu, tongSang, tongTrua, tongToi;
    private String name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RecommendMenuNum3Activity.this, RecommendMenuActivity.class);
