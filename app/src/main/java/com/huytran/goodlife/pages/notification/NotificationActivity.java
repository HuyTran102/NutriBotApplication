...
public class NotificationActivity extends AppCompatActivity {
    ...
    public void loadData() {
        ...
        firebaseFirestore.collection("GoodLife").document(name).collection("Thông Báo").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    // Loop through all documents
                    for (QueryDocumentSnapshot document : task.getResult()) {
                        NotificationDataActivity new_item = new NotificationDataActivity(document.getString("name"), document.getString("information"), document.getString("time"), document.getString("date"));
