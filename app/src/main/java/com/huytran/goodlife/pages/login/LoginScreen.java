package com.huytran.goodlife.pages.login;
...
import com.huytran.goodlife.pages.register.RegisterPage;
...
//                            e.printStackTrace();
                            if(e instanceof IOException) {
                                Toast.makeText(LoginScreen.this, "Lỗi đăng nhập", Toast.LENGTH_SHORT).show();
                            }
                        }
